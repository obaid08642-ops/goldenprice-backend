...
// Optional: GoldAPI / GoldPriceZ (precious)
...
/* ---------------------- PERIODIC FMP REFRESH (كل 6 دقايق) ---------------------- */
// حتى لو كل شيء شغال، نعمل refresh احتياطي من FMP بدون ما نكسر الليمِت اليومي.
const FMP_REFRESH_MS = 6 * 60 * 1000;
const FMP_METALS = Object.entries(METALS)
  .filter(([,m]) => !!m.fmp) // اللي لهم رمز FMP
